    ...
    def getMatchData(self):
        ...
        for match in matchQuery:
            if match['comp_level'] == "qm":
                ...
                matchData.append({"event_name":self.eventName,"event_key":self.eventKey,"number":match["match_number"],"time":match['predicted_time'],"red":{"teams":{"1":match['alliances']['red']['team_keys'][0],
